...
tema_bruno <- function() {
   ggplot2::theme(
      ...
      plot.subtitle = ggplot2::element_text(hjust = 1, face = "italic", size = 16),
      text = ggplot2::element_text(colour = "#11a2c6"),
      # Bloco sobre os eixos...
      axis.text = ggplot2::element_text(color = "#5889c8", size = 16),
      axis.title = ggplot2::element_text(color = "#11a2c6", size = 16),
