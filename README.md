...
atualiza_dados()
#> 
#> Atualizacao de dados iniciada em 2021-03-12 22:47:13
#> 
...
#> )
#> 
#> Concluida a importacao de dados do Portal Brasil.io em 30.95 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a importacao de dados do Ministerio da Saude em 484.94 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a organizacao de todas as informacoes levantadas em 6.22 segundos.
#> 
#> 
#> 
#> Parabens! Agora voce esta com a base atualizada!
#> 
#> O processamento foi concluido em 526.52 segundos.
#> 
...
disponível (no caso, 2021-03-12) não batem exatamente com os números
...
números veiculados pela grande imprensa.
    ...
    #> 1  2021-03-12      11.333.789      274.624            2,42%
...
#> 
#> 
#> Concluida a geracao da Base Derivada ao Nivel de Cidades em 13.07 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a geracao da Base Derivada ao Nivel de Regioes de Saude em 4.86 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a geracao da Base Derivada ao Nivel de Estados em 6.85 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a geracao da Base Derivada ao Nivel de Regioes do Brasil em 4.65 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a geracao da Base Derivada ao Nivel de Brasil em 0.37 segundos.
#> 
#> 
#> 
#> Parabens! Agora voce esta com todas as bases derivadas!
#> 
#> O processamento foi concluido em 32.06 segundos.
#> 
...
Atualização dos Dados no GitHub - 12/03/2021.
