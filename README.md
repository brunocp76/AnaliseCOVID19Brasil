...
atualiza_dados()
#> 
#> Atualizacao de dados iniciada em 2021-03-06 23:16:23
#> 
...
#> )
#> 
#> Concluida a importacao de dados do Portal Brasil.io em 31.03 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a importacao de dados do Ministerio da Saude em 462.26 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a carga de Informacoes Auxiliares em 4.31 segundos.
#> 
#> 
#> 
...
#> 
#> O processamento foi concluido em 503.68 segundos.
#> 
...
disponível (no caso, 2021-03-06) não batem exatamente com os números
...
números veiculados pela grande imprensa.
    ...
    #> 1  2021-03-06      10.894.018      263.867            2,42%
...
#> 
#> 
#> Concluida a geracao da Base Derivada ao Nivel de Cidades em 12.84 segundos.
#> 
#> 
#> 
...
#> 
#> O processamento foi concluido em 31.72 segundos.
#> 
...
Atualização dos Dados no GitHub - 06/03/2021.
