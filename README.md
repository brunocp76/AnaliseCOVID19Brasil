...
atualiza_dados()
#> 
#> Atualizacao de dados iniciada em 2021-01-20 01:00:20
#> 
...
#> )
#> 
#> Concluida a importacao de dados do Portal Brasil.io em 33.97 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a importacao de dados do Ministerio da Saude em 501.59 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a carga de Informacoes Auxiliares em 5.43 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a organizacao de todas as informacoes levantadas em 6.48 segundos.
#> 
#> 
#> 
#> Parabens! Agora voce esta com a base atualizada!
#> 
#> O processamento foi concluido em 547.47 segundos.
#> 
...
disponível (no caso, 2021-01-19) não batem exatamente com os números
...
números veiculados pela grande imprensa.
    ...
    #> 1  2021-01-19       8.533.683      210.905            2,47%
...
#> 
#> 
#> Concluida a geracao das sumarizacoes de area e populacao em 3.23 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a geracao da Base Derivada ao Nivel de Cidades em 20.47 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a geracao da Base Derivada ao Nivel de Regioes de Saude em 6.45 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a geracao da Base Derivada ao Nivel de Estados em 8.7 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a geracao da Base Derivada ao Nivel de Brasil em 0.5 segundos.
#> 
#> 
#> 
#> Parabens! Agora voce esta com todas as bases derivadas!
#> 
#> O processamento foi concluido em 45.65 segundos.
#> 
...
Atualização dos Dados no GitHub - 19/01/2021.
