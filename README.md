...
atualiza_dados()
#> 
#> Atualizacao de dados iniciada em 2021-01-31 19:21:51
#> 
...
#> )
#> 
#> Concluida a importacao de dados do Portal Brasil.io em 43.14 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a importacao de dados do Ministerio da Saude em 586.47 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a carga de Informacoes Auxiliares em 4.2 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a organizacao de todas as informacoes levantadas em 7.04 segundos.
#> 
#> 
#> 
#> Parabens! Agora voce esta com a base atualizada!
#> 
#> O processamento foi concluido em 640.85 segundos.
#> 
...
disponível (no caso, 2021-01-30) não batem exatamente com os números
...
números veiculados pela grande imprensa.
    ...
    #> 1  2021-01-30       9.134.929      223.374            2,45%
...
#> 
#> 
#> Concluida a geracao das sumarizacoes de area e populacao em 3.77 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a geracao da Base Derivada ao Nivel de Cidades em 17.67 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a geracao da Base Derivada ao Nivel de Regioes de Saude em 6.21 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a geracao da Base Derivada ao Nivel de Estados em 7.31 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a geracao da Base Derivada ao Nivel de Regioes do Brasil em 5.65 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a geracao da Base Derivada ao Nivel de Brasil em 0.44 segundos.
#> 
#> 
#> 
#> Parabens! Agora voce esta com todas as bases derivadas!
#> 
#> O processamento foi concluido em 41.05 segundos.
#> 
...
Atualização dos Dados no GitHub - 31/01/2021.
