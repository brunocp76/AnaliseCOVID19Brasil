...
atualiza_dados()
#> 
#> Atualizacao de dados iniciada em 2022-01-20 14:39:28
#> 
#> Etapa 1: Carregando dados do Portal Brasil.io.
#> 
#> Por favor aguarde...
#> Rows: 2757432 Columns: 13
...
#> 
#> 
#> Concluida a importacao de dados do Ministerio da Saude em 4.07 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a organizacao de todas as informacoes levantadas em 6.77 segundos.
#> 
#> 
#> 
#> Parabens! Agora voce esta com a base atualizada!
#> 
#> O processamento foi concluido em 41.58 segundos.
#> 
...
disponível (no caso, 2022-01-18) não batem exatamente com os números
...
números veiculados pela grande imprensa.
    ...
    #> 1  2022-01-18      22.003.253      607.232            2,76%
...
#> 
#> 
#> Concluida a geracao da Base Derivada ao Nivel de Cidades em 7.92 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a geracao da Base Derivada ao Nivel de Regioes de Saude em 4.34 segundos.
#> 
#> 
#> 
...
#> 
#> 
#> Concluida a geracao da Base Derivada ao Nivel de Estados em 7 segundos.
#> 
#> 
#> 
...
#> 
#> O processamento foi concluido em 26.22 segundos.
#> 
