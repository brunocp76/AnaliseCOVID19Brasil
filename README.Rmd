...
```{r Maiores_Contagios_nos_Estados, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 6, fig.cap = "Gráfico 01 - Animação dos 5 estados com maiores volumes de Contágio pela Pandemia"}
covid_estados %>%
...
```{r Maiores_Obitos_nos_Estados, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 6, fig.cap = "Gráfico 02 - Animação dos 5 estados com maiores volumes de Óbitos pela Pandemia"}
covid_estados %>%
   dplyr::group_by(uf, date) %>%
...
```{r Volumes_Diarios_de_Contagios, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 6, fig.cap = "Gráfico 03 - Volumes Diários de Novos Contágios no Brasil"}
covid_brasil %>%
   ggplot2::ggplot() +
...
```{r Volumes_Diarios_de_Obitos, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 6, fig.cap = "Gráfico 04 - Volumes Diários de Novos Óbitos no Brasil"}
covid_brasil %>%
   ggplot2::ggplot() +
...
```{r Volumes_Estaduais_de_Contagios, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 6, fig.cap = "Gráfico 05 - Volumes Diários de Novos Contágios por Estado"}
covid_estados %>%
   dplyr::mutate(
...
```{r Volumes_Estaduais_de_Obitos, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 6, fig.cap = "Gráfico 06 - Volumes Diários de Novos Óbitos por Estado"}
covid_estados %>%
   dplyr::mutate(
...
```{r Correlacao_Cruzada_entre_Contagios_e_Obitos, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 6, fig.cap = "Gráfico 07 - Correlação Cruzada entre Contágios e Óbitos"}
teste <- covid %>%
   dplyr::select(
      date,
      contagios_novos,
...
```{r Volumes_de_Novos_Contagios_por_Estado, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 6, fig.cap = "Gráfico 08 - Volumes de Novos Contágios por Estado"}
covid_estados %>%
   dplyr::mutate(
...
```{r Volumes_de_Novos_Obitos_por_Estado, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 6, fig.cap = "Gráfico 09 - Volumes de Novos Óbitos por Estado"}
covid_estados %>%
   dplyr::mutate(
...
```{r Taxas_de_Mortalidade_no_Brasil, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 11, fig.cap = "Gráfico 10 - Taxas de Mortalidade por Estado"}
...
```
Vamos ver o histórico desta taxa de mortalidade (a razão entre a quantidade de óbitos e a quantidade de contágios).

Ordenarei as regiões pelo tamanho da população.

```{r Taxas_de_Mortalidade_por_Estados_do_Sudeste, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 6, fig.cap = "Gráfico 11 - Evolução das Taxas de Mortalidade por Estado na Região Sudeste"}
covid_estados %>%
...
```{r Taxas_de_Mortalidade_por_Estado_do_Nordeste, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 6, fig.cap = "Gráfico 12 - Evolução das Taxas de Mortalidade por Estado na Região Nordeste"}
covid_estados %>%
...
```{r Taxas_de_Mortalidade_por_Estado_do_Sul, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 6, fig.cap = "Gráfico 13 - Evolução das Taxas de Mortalidade por Estado na Região Sul"}
covid_estados %>%
...
```{r Taxas_de_Mortalidade_por_Estado_do_Norte, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 6, fig.cap = "Gráfico 14 - Evolução das Taxas de Mortalidade por Estado na Região Norte"}
covid_estados %>%
...
```{r Taxas_de_Mortalidade_por_Estado_do_Centro_Oeste, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 6, fig.cap = "Gráfico 15 - Evolução das Taxas de Mortalidade por Estado da Região Centro-Oeste"}
covid_estados %>%
...
```{r Taxa_de_Mortalidade_no_Brasil, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 6, fig.cap = "Gráfico 16 - Animação da Evolução da Taxa de Mortalidade no Brasil"}
covid_brasil %>%
   ggplot2::ggplot() +
...
```{r Contagios_Acumulados_por_100_mil_habitantes, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 10, fig.cap = "Gráfico 17 - Contágios Acumulados por 100 mil habitantes nos Municípios da Região Sudeste"}
