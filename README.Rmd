...
```{r Volumes_de_Novos_Contagios_por_Estado, echo = F, warning = F, message = F, fig.align = "center", fig.cap = "Gráfico 01 - Volumes de Novos Contágios por Estado"}
covid_estados %>%
   dplyr::mutate(
...
```{r Maiores_Contagios_nos_Estados, echo = F, warning = F, message = F, fig.align = "center", fig.cap = "Gráfico 02 - Animação dos 5 estados com maiores volumes de Contágio pela Pandemia"}
covid_estados %>%
...
```{r Volumes_Diarios_de_Contagios, echo = F, warning = F, message = F, fig.align = "center", fig.cap = "Gráfico 03 - Volumes Diários de Novos Contágios no Brasil"}
covid_brasil %>%
   ggplot2::ggplot() +
...
```{r Volumes_Estaduais_de_Contagios_Sudeste, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 10, fig.cap = "Gráfico 04 - Volumes Diários de Novos Contágios por Estado da Região Sudeste"}
covid_estados %>%
...
```{r Volumes_Estaduais_de_Contagios_Sul, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 10, fig.cap = "Gráfico 06 - Volumes Diários de Novos Contágios por Estado da Região Sul"}
covid_estados %>%
...
```{r Volumes_Estaduais_de_Contagios_Centro_Oeste, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 10, fig.cap = "Gráfico 07 - Volumes Diários de Novos Contágios por Estado da Região Centro-Oeste"}
covid_estados %>%
...
```{r Volumes_de_Novos_Obitos_por_Estado, echo = F, warning = F, message = F, fig.align = "center", fig.cap = "Gráfico 09 - Volumes de Novos Óbitos por Estado"}
covid_estados %>%
   dplyr::mutate(
...
```{r Maiores_Obitos_nos_Estados, echo = F, warning = F, message = F, fig.align = "center", fig.cap = "Gráfico 10 - Animação dos 5 estados com maiores volumes de Óbitos pela Pandemia"}
covid_estados %>%
   dplyr::group_by(uf, date) %>%
...
```{r Volumes_Diarios_de_Obitos, echo = F, warning = F, message = F, fig.align = "center", fig.cap = "Gráfico 11 - Volumes Diários de Novos Óbitos no Brasil"}
covid_brasil %>%
   ggplot2::ggplot() +
...
```{r Volumes_Estaduais_de_Obitos_Sudeste, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 10, fig.cap = "Gráfico 12 - Volumes Diários de Novos Óbitos por Estado da Região Sudeste"}
covid_estados %>%
   dplyr::filter(regiao == "Sudeste") %>% 
   dplyr::mutate(
...
```{r Volumes_Estaduais_de_Obitos_Sul, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 10, fig.cap = "Gráfico 14 - Volumes Diários de Novos Óbitos por Estado da Região Sul"}
covid_estados %>%
   dplyr::filter(regiao == "Sul") %>% 
   dplyr::mutate(
      uf = forcats::fct_reorder(.f = uf, .x = obitos_acumulados, .desc = TRUE)
...
```{r Volumes_Estaduais_de_Obitos_Centro_Oeste, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 10, fig.cap = "Gráfico 15 - Volumes Diários de Novos Óbitos por Estado da Região Centro-Oeste"}
covid_estados %>%
   dplyr::filter(regiao == "Centro-Oeste") %>% 
   dplyr::mutate(
      uf = forcats::fct_reorder(.f = uf, .x = obitos_acumulados, .desc = TRUE)
...
```{r Correlacao_Cruzada_entre_Contagios_e_Obitos, echo = F, warning = F, message = F, fig.align = "center", fig.cap = "Gráfico 17 - Correlação Cruzada entre Contágios e Óbitos"}
teste <- covid %>%
   dplyr::select(
      date,
      contagios_novos,
...
dplyr::tibble(lags, correlacoes) %>%
   ...
   ggplot2::scale_y_continuous(breaks = seq(0, 0.7, 0.1)) +
   tema_bruno()
...
```{r Taxas_de_Mortalidade_no_Brasil, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 10, fig.cap = "Gráfico 18 - Taxas de Mortalidade por Estado"}
...
```{r Taxas_de_Mortalidade_por_Estados_do_Sudeste, echo = F, warning = F, message = F, fig.align = "center", fig.cap = "Gráfico 19 - Evolução das Taxas de Mortalidade por Estado na Região Sudeste"}
covid_estados %>%
   dplyr::filter(regiao == "Sudeste") %>%
   dplyr::mutate(
...
```{r Taxas_de_Mortalidade_por_Estado_do_Nordeste, echo = F, warning = F, message = F, fig.align = "center", fig.cap = "Gráfico 20 - Evolução das Taxas de Mortalidade por Estado na Região Nordeste"}
covid_estados %>%
   dplyr::filter(regiao == "Nordeste") %>%
   dplyr::mutate(
      uf = forcats::fct_reorder(.f = uf, .x = taxa_mortalidade, .desc = TRUE),
...
```{r Taxas_de_Mortalidade_por_Estado_do_Sul, echo = F, warning = F, message = F, fig.align = "center", fig.cap = "Gráfico 21 - Evolução das Taxas de Mortalidade por Estado na Região Sul"}
covid_estados %>%
   dplyr::filter(regiao == "Sul") %>%
   dplyr::mutate(
      uf = forcats::fct_reorder(.f = uf, .x = taxa_mortalidade, .desc = TRUE),
...
```{r Taxas_de_Mortalidade_por_Estado_do_Centro_Oeste, echo = F, warning = F, message = F, fig.align = "center", fig.cap = "Gráfico 22 - Evolução das Taxas de Mortalidade por Estado da Região Centro-Oeste"}
covid_estados %>%
   dplyr::filter(regiao == "Centro-Oeste") %>%
   dplyr::mutate(
      uf = forcats::fct_reorder(.f = uf, .x = taxa_mortalidade, .desc = TRUE),
...
```{r Taxas_de_Mortalidade_por_Estado_do_Norte, echo = F, warning = F, message = F, fig.align = "center", fig.cap = "Gráfico 23 - Evolução das Taxas de Mortalidade por Estado na Região Norte"}
covid_estados %>%
   dplyr::filter(regiao == "Norte") %>%
   dplyr::mutate(
      uf = forcats::fct_reorder(.f = uf, .x = taxa_mortalidade, .desc = TRUE),
...
```{r Taxa_de_Mortalidade_no_Brasil, echo = F, warning = F, message = F, fig.align = "center", fig.cap = "Gráfico 24 - Animação da Evolução da Taxa de Mortalidade no Brasil"}
covid_brasil %>%
   ggplot2::ggplot() +
...
```{r Contagios_Acumulados_por_100_mil_habitantes, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 10, fig.cap = "Gráfico 25 - Contágios Acumulados por 100 mil habitantes nos Municípios da Região Sudeste"}
tabela_ufs <- geobr::read_state(
   code_state = "all",
   year = 2019,
   showProgress = FALSE
