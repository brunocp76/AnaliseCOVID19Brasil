...
```{r Volumes Estaduais de Contágios, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 6, fig.cap = "Gráfico 05 - Volumes Diários de Novos Contágios por Estado"}
covid_estados %>%
   dplyr::mutate(
   ...
   ggplot2::facet_wrap(vars(uf), scales = "free")
```

...e em seguida dos volumes diários de óbitos.

```{r Volumes Estaduais de Óbitos, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 6, fig.cap = "Gráfico 06 - Volumes Diários de Novos Óbitos por Estado"}
covid_estados %>%
   dplyr::mutate(
...
```{r Correlações Cruzadas entre Contágios e Óbitos, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 6, fig.cap = "Gráfico 07 - Correlações Cruzadas entre Contágios e Óbitos"}
teste <- covid %>%
   dplyr::select(
      date,
      contagios_novos,
...
```{r Volumes de Novos Contágios por Estado, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 6, fig.cap = "Gráfico 08 - Volumes de Novos Contágios por Estado"}
covid_estados %>%
   dplyr::mutate(
...
```{r Volumes de Novos Óbitos por Estado, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 6, fig.cap = "Gráfico 09 - Volumes de Novos Óbitos por Estado"}
covid_estados %>%
   dplyr::mutate(
...
```{r Taxas de Mortalidade por Estado, echo = F, warning = F, message = F, fig.align = "center", fig.width = 11, fig.height = 6, fig.cap = "Gráfico 10 - Taxas de Mortalidade por Estado"}
covid_estados %>%
   dplyr::mutate(
