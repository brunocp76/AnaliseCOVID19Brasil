...
```{r Contagios_Acumulados_por_100_mil_hab_Nordeste, echo = F, warning = F, message = F, fig.align = "center", fig.width = 10, fig.height = 12, fig.cap = "Gráfico 26 - Contágios Acumulados por 100 mil habitantes nos Municípios da Região Nordeste"}
covid_cidades %>%
   dplyr::filter(regiao == "Nordeste") %>%
   dplyr::arrange(cod_ibge, date) %>%
   dplyr::group_by(cod_ibge) %>%
...
```{r Contagios_Acumulados_por_100_mil_hab_Centro_Oeste, echo = F, warning = F, message = F, fig.align = "center", fig.width = 10, fig.height = 12, fig.cap = "Gráfico 28 - Contágios Acumulados por 100 mil habitantes nos Municípios da Região Centro-Oeste"}
covid_cidades %>%
   dplyr::filter(regiao == "Centro-Oeste") %>%
   dplyr::arrange(cod_ibge, date) %>%
   dplyr::group_by(cod_ibge) %>%
